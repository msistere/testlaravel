...
<div class="container-fluid">
	<div class="fade-in">
		<div class="row">
			<div class="col-sm-12">
				<div class="card">
					{!! Form::open(['id' => 'product', 'route' => 'productos.store', 'enctype' => 'multipart/form-data', 'accept-charset' => 'utf-8', 'class' => 'needs-validation', 'novalidate']) !!}
